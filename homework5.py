...
# Мне для того, что бы ответить на все вопросы развёрнуто, нужно привести несколько своих примеров.
# Позволю себе немного отойти от шаблона ответа. Если эта вольность будет излишней, прошу мне написать. Исправлю.
